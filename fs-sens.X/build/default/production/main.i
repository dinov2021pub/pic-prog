...
# 52 "C:/Users/user/.mchp_packs/Microchip/PIC12-16F1xxx_DFP/1.6.241/xc8\pic\include\proc\pic16f1788.h"
...
# 76 "C:/Users/user/.mchp_packs/Microchip/PIC12-16F1xxx_DFP/1.6.241/xc8\pic\include\pic.h"
...
# 118 "C:/Users/user/.mchp_packs/Microchip/PIC12-16F1xxx_DFP/1.6.241/xc8\pic\include\pic.h"
...
_delay((unsigned long)((5)*(160000000/4000000.0)));
...
val = 0;
val = AD_convert();
voltage = (double)val * 5.0 / 1023.0;
printf("AIN/%.3fV\r\n", voltage);
_delay((unsigned long)((300)*(160000000/4000.0))) ;
}
}
...
if(cmd_ready == 0 && RB3 == 1 && strcmp(tmp,"QQQ") != 0){
cmd = ERR;
}
}
ptr = strtok(tmp, "/");
...
for(j = 0 ; j < intvl ; j++){
_delay((unsigned long)((1)*(160000000/4000000.0)));
}
RA0 = 0;
for(j = 0 ; j < intvl ; j++){
_delay((unsigned long)((1)*(160000000/4000000.0)));
...
_delay((unsigned long)((100)*(160000000/4000.0)));
t_intvl = (int)(intvl * 2);
for(k = 0 ; k < dist_slow ; k++){
RA0 = 1;
if(npos < 1000000){
...
_delay((unsigned long)((100)*(160000000/4000000.0))) ;
DAC1CON1 = (int)pzt_d;
c_pzt = (int)pzt_d;
pzt_d = pzt_d + pzt_l_d;
}
for (k = 0; k < pzt_wt; k++){
_delay((unsigned long)((1)*(160000000/4000.0))) ;
}
DAC1CON1 = 0;
c_pzt = 0;
printf("C\tPMV\r\n");
...
for (k = 0;k < exp_div; k++){
_delay((unsigned long)((5)*(160000000/4000.0))) ;
...
voltage = (double)val * 5.0 / 1023.0;
printf("AIN/%.3fV\r\n", voltage);
_delay((unsigned long)((500)*(160000000/4000.0))) ;
}
printf("C\tAIN\r\n");
break;
...
case VER :
printf("C\tFS-SENS VERSION 0.0.0\r\n");
break;
