 ...
 * File:   main.c
 *
 * Program for aquiring sensor analog output and send them to PC via USART
 * 
 * Author: Shuichi Dejima
 *
 * Created on 2025/12/04, 8:10
 * Release on 2025/12/04, 8:10
 * Modified from fs-cont3 on 2025/12/18
 * 
 ...
 * Git test 2
 * Version : 3.0.0
 * Upgraded from cont2 (2025/12/04)  Change crystal oscillation from 4MHz to 16MHz
 *  */
...
void main(void) {
    ...
    ANSELBbits.ANSB1 = 1; // RB1 をアナログ入力（AN10）に設定
    ...
    //ADCON1 = 0b10100011;    // bit7(ADFM)=1(right justified), bit<6:4>=010 Fosc/32=1.0us
                            // bit<1:0>=00 VREF+=FVR
    //FVRCON = 0b10000010;    // bit7(FVRON)=1,bit<1:0>=10 ADFVRﾃ?2=2.048V
